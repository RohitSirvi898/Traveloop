      ...
      <div className="flex-1 p-8">
        ...
        {filteredTrips.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            {/* Add New Trip Card */}
            <div className="bg-white dark:bg-slate-900 rounded-lg border-2 border-dashed border-slate-300 dark:border-slate-700 flex flex-col items-center justify-center p-8 hover:border-teal-500 hover:bg-teal-50 dark:hover:bg-teal-900/10 transition-colors cursor-pointer min-h-[300px]">
