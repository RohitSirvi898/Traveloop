  ...
  return (
    <div className="min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Animated blobs */}
        <motion.div
          className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-green-500 to-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10"
          animate={{
            x: [0, 30, 0],
            y: [0, 30, 0],
          }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <div className="relative">
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-green-500 to-blue-500 rounded-xl blur-lg opacity-75"
                  animate={{ scale: [1, 1.1, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                />
                <div className="relative bg-gradient-to-r from-green-500 to-blue-500 p-2 rounded-xl">
                  <Plane className="w-6 h-6 text-white" />
                </div>
              </div>
              <span className="text-3xl font-bold bg-gradient-to-r from-green-400 via-blue-400 to-emerald-400 bg-clip-text text-transparent">
                Traveloop
              </span>
            </motion.div>
            ...
            >
              Discover amazing destinations, build unforgettable itineraries, and travel with confidence.
            </motion.p>

            {/* Feature cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              {[
                { icon: MapPin, title: 'Explore', desc: 'Discover new destinations' },
                { icon: Users, title: 'Connect', desc: 'Travel with friends' },
                { icon: Star, title: 'Curate', desc: 'Save favorite places' },
                { icon: Plane, title: 'Plan', desc: 'Build perfect itineraries' },
              ].map((feature, i) => (
                <motion.div
                  key={i}
                  className="p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-green-500/50 hover:bg-white/10 transition-all"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="w-full max-w-md">
              ...
              >
                {/* Premium glow effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-green-500/30 via-blue-500/20 to-emerald-500/20 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    ...
                    <SignIn
                      appearance={{
                        elements: {
                          ...
                          formFieldInput:
                            'bg-white/8 border border-white/20 text-white placeholder-slate-400/60 focus:bg-white/15 focus:border-green-400/60 focus:ring-2 focus:ring-green-500/20 rounded-xl transition-all duration-300 px-4 py-3',
                          formButtonPrimary:
                            'bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 active:from-green-700 active:to-blue-700 text-white font-bold rounded-xl py-3 shadow-lg hover:shadow-xl transition-all duration-200 w-full',
                          footerActionLink: 'text-green-300 hover:text-green-200 font-medium transition-colors',
                          identifierMobileLink: 'text-green-300 hover:text-green-200 font-medium transition-colors',
                          otpCodeFieldInput:
                            'bg-white/8 border border-white/20 text-white focus:bg-white/15 focus:border-green-400/60 focus:ring-2 focus:ring-green-500/20 rounded-xl transition-all duration-300',
                          formResendCodeLink: 'text-green-300 hover:text-green-200 font-medium transition-colors',
                          form: 'space-y-5',
                          ...
                          button: 'text-green-300 hover:text-green-200 transition-colors font-medium',
                          backButton: 'text-slate-300 hover:text-white transition-colors font-medium',
                          toggleButton: 'text-green-300 hover:text-green-200 transition-colors font-medium',
                          ...
                          accordionTrigger: 'text-white hover:text-teal-300 transition-colors font-medium',
                          accordionContent: 'text-slate-300 text-sm',
                          badge: 'bg-green-500/30 text-green-200 border border-green-500/50 px-3 py-1 rounded-full text-xs font-semibold',
                          internalProcessSpinner: '[&>svg]:text-green-400',
                          activeDevice: 'border-green-400/60 bg-green-500/15',
                          activeDeviceIcon: 'text-green-300',
                        },
                        variables: {
                          colorPrimary: '#22c55e',
                          colorText: '#ffffff',
              ...
              <motion.div
                className="absolute -bottom-20 -left-20 w-32 h-32 bg-gradient-to-br from-green-500 to-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 group-hover:opacity-30"
